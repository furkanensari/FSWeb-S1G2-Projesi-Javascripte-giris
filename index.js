 ...
 */
 ...
 console.log(kopeginYasi(35));


/* Görev 3 */
/*
Aşağıdakileri oyun isimli fonksiyonu kullanarak yap.
1. 2 argüman alın: oyuncunun tercihini alan bir string değer: "Taş", "Kağıt" veya "Taş" 
...
function feetDonusturucu(num) {
  let Santimetre = num / 30.48
  return Santimetre;
}
...
for(let p = 5; p >0; p=p-1) {
  console.log(cocukSarkisi(p));
}
